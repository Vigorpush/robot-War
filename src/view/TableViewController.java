...
public class TableViewController {
	...
	private void initialize() {
		robot1Column.setCellValueFactory(cellData -> cellData.getValue().getAllergyType());
		robot1Column.setMinWidth(75);
		robot1Column.setResizable(false);

		robot2Column.setCellValueFactory(cellData -> cellData.getValue().getAllergicTo());
		robot2Column.setMinWidth(75);
		robot2Column.setResizable(false);

		robot3Column.setCellValueFactory(cellData -> cellData.getValue().getDescription());
